...
import about_us_right from '../assets/images/Home/about_us_right.png' 
import about_us from '../assets/images/Home/about_us.png'  
import mother from '../assets/images/Home/mother.png' 
import weight_scale from '../assets/images/Home/weight-scale.png' 
import sugar_blood from '../assets/images/Home/sugar-blood-level.png'  
import kidneys from '../assets/images/Home/kidneys.png' 
...
import Choose_a_specialty from '../assets/images/Home/Choose_a_specialty.png' 
import Connect_rdn from '../assets/images/Home/Connect_rdn.png'  
...
import Why_Trust_Us from '../assets/images/Home/Why_Trust_Us.png' 
...
import join_our_diet_img from '../assets/images/Home/join_our_diet_img.png'
             ...
             <div className='Why_trust_us_iteme'>
                 ...
                 <div className='card_item'>
                    <div className='img_item bg_blue'><img className='' src= {Nutrition_Experts} alt="team3"/></div>
                     ...
                     <p>Every Registered Dietitian Nutritionist is a nutritionist but not every “nutritionist” is a Registered Dietitian Nutritionist. RDN’s are the food and nutrition experts. What makes us food and nutrition experts?</p>
                 </div> 
             </div>
         </div>
         </div> 
               ...
               <div className='row'>
                 <div className='col-lg-6 '>
                     <div className='Join_our_platform_content'>
                       ...
                       <p>We will promote your profile, you'll receive high quality leads and gain access to our exclusive 'RD Chat' where you'll connect with other dietitians in private practice. </p>
                       <p></p>
                     </div>
                 </div>
